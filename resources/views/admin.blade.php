...
<link href="{{asset('css/backapp.css')}}" rel="stylesheet">
                                ...
                                <table id="datatablesSimple">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Image</th>
                                            <th>Status</th>
                                            <th colspan="3" scope="colgroup" style="text-align:center">Operations</th>
                                        </tr>
  ...
  @foreach($members as $member)
        <tr>
            ...
            <td>  <img  style="width:200px"src="/uploads/{{$member->image}}"  alt="hello "></td>
            
            @if($member->status=="Pending")
                        <td><a  href={{"/approve/".$member['id'] }} class="btn btn-danger">
                                Pending...
                            </a></td>
                        @else
                        <td>
                            ...
                            <div class="form-group">
                                <a href={{"/pending/".$member['id'] }} class="btn btn-success">
                                    Approved
                                </a>
                            </div>
                        </td>
                        @endif
<td><a href={{"/more/".$member['id']}} class="btn btn-primary">view</a></td>

<td><a href={{"/delete/".$member['id']}} class="btn btn-secondary">delete</a></td>
        </tr>
  ...
  $(function() {
    $('.toggle-class').change(function() {
        ...
        $.ajax({
            ...
            dataType: "json",
            url: '/changeStatus',
            data: {'status': status, 'us_id': us_id},
